...
export default function OrdersPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Seguimiento de Pedidos</h1>
              ...
              {orders.map((order) => (
                ...
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell className="hidden md:table-cell">{order.sellerName || 'N/A'}</TableCell>
